		...
		<div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
			<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
				...
				<p class="mt-6 text-lg leading-8 text-gray-600">
					We’re excited to hear from you! Whether you’re interested in our services or have questions, we’re here to
					help. Feel free to reach out to us using the contact, or connect with us directly via email or phone. Our team
					is dedicated to providing personalized assistance and finding the best solutions to meet your needs. Let’s
					start the conversation and explore how we can work together to achieve your goals.
				</p>
