<script lang="ts">
	...
	$: ({ page } = $About.data ?? {});
	$: valuesParagraphs = page?.values?.paragraphs ? groupArrayIntoPairs(page.values.paragraphs) : [];
</script>
...
{#if page}
	...
	<div class="relative isolate">
		...
		>
			<div
				class="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#61cfda] to-[#4260b3] opacity-30"
