<div class="mx-auto prose max-w-prose my-24 text-center">
...
<div class="prose prose-sm prose-slate mx-auto max-w-prose prose-fuchsia prose-a:font-semibold mb-24">
	<p>
		At Devologic, accessible from https://devologic.com, one of our main priorities is the privacy of our visitors. This
		Privacy Policy document contains types of information that is collected and recorded by Devologic and how we use it.
	</p>
	...
	<p>
		...
		their respective advertisements and links that appear on Devologic, which are sent directly to users' browser. They
	...
	<p>
		Devologic's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
	...
	<p>
		Devologic does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
